...
class NegotiationRolloutEnginePropose:
    ...
    def compute_best_response(
        ...
        for candidate_idx in range(len(self.action_library)):
    ...
    def _simulate_rollout(
        ...
        opponent_initial_offer = self.action_library[opponent_first_action]
        first_reward = float(opponent_util_fn(opponent_initial_offer))
        cummulative += first_reward
