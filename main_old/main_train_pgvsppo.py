...
from reward_shaper.reward_shaper import RewardConfig, RewardShaper
...
def main():
    ...
    # ── Reward shaper untuk user ────────────────────────────────────
    reward_cfg_user = RewardConfig(
        reward_mode=cfg["training"]["reward_mode"],
        terminal_bonus=cfg["training"]["terminal_bonus"],
        no_deal_penalty=cfg["training"]["no_deal_penalty"],
        time_penalty=cfg["training"]["time_penalty"],
        utility_scale=cfg["training"]["utility_scale"],
    )
    reward_shaper_user = RewardShaper(
        reward_cfg_user,
    ...
    propose_trainer_user = PPOTrainer(
        ...
        device="cpu",
        epoch=10,
        reward_shaper=reward_shaper_user,
        batch_size=32,
    )
    ...
    # ── Reward shaper untuk opponent ─────────────────────────────────
    reward_cfg_opponent = RewardConfig(
        reward_mode=cfg["training"]["reward_mode"],
        terminal_bonus=cfg["training"]["terminal_bonus"],
        no_deal_penalty=cfg["training"]["no_deal_penalty"],
        time_penalty=cfg["training"]["time_penalty"],
    ...
    reward_shaper_opponent = RewardShaper(
        reward_cfg_opponent,
        utility_min=domain_spec.utility_min,
        utility_max=domain_spec.utility_max,
    )
    ...
    propose_trainer_opponent = PolicyGradientTrainer(
        ...
        device="cpu",
        batch_size=32,
        reward_shaper=reward_shaper_opponent,
    )
